...
function IconAccessBotChat({
  ...
  return (
    ...
    >
      ...
      {/* Chat bubble */}
      <path d="M4 4H28V24H8L4 28V4Z" fill={inverted ? 'black' : 'white'} />
      {/* Letter A */}
      <path
        d="M13,20 L16,14 L19,20"
...
function IconLogin({ className, ...props }: React.ComponentProps<'svg'>) {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 512 512"
